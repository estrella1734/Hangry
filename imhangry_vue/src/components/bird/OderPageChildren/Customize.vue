<template>
    ...
    <div class="meanness">
    <el-dialog v-model="dialogFormVisible" :title="productData.productName" width="400px"
    @close="clearData" >
        <el-form label-position="top">
            ...
            <span class="dialog-footer">
                ...
                <div class="footer-right"><button type="button" class="btn btn-primary btn-submit"
                        @click="addProduct">添加至購物車</button>
                </div>
...
const { dialogFormVisible, customizeList, productData,businessUser } = storeToRefs(orderPageStore)
